...
class CILQRConstraint {
 public:
  ...
  virtual void ComputeConstraintQuadraticApproximation(
      ...
      const int32_t &step, Eigen::MatrixXd &c_x, Eigen::MatrixXd &c_u,
...
class CILQRConstraintManager {
 public:
  ...
  double ComputeStepConstriants(Eigen::VectorXd state_vec,
  ...
  void ComputeAugmentedQuadraticApproximation(
      ...
      Eigen::MatrixXd &c_x, Eigen::MatrixXd &c_u, Eigen::MatrixXd &c_xx,
